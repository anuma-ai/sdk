...
> **encryptMemoriesBatchInPlace**(`memories`, `address`, `updateFn`, `batchSize`): `Promise`\<\{ `errors`: `object`[]; `failed`: `string`[]; `success`: `number`; \}\>

Defined in: [src/lib/db/memory/encryption.ts:468](https://github.com/zeta-chain/ai-sdk/blob/main/src/lib/db/memory/encryption.ts#L468)
...
`Promise`\<\{ `errors`: `object`[]; `failed`: `string`[]; `success`: `number`; \}\>
