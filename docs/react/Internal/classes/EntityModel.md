...
Defined in: [src/lib/db/entities/models.ts:14](https://github.com/anuma-ai/sdk/blob/main/src/lib/db/entities/models.ts#14)

A canonical entity (person, place, thing) extracted from the user's
conversations. Many-to-many with vault memories via [MemoryEntity](MemoryEntityModel.md).
...
> **new EntityModel**(`collection`: `Collection`<`Model`>, `raw`: `_RawRecord`): `Entity`
...
Defined in: [src/lib/db/entities/models.ts:18](https://github.com/anuma-ai/sdk/blob/main/src/lib/db/entities/models.ts#18)
...
Defined in: [src/lib/db/entities/models.ts:21](https://github.com/anuma-ai/sdk/blob/main/src/lib/db/entities/models.ts#21)
...
Defined in: [src/lib/db/entities/models.ts:20](https://github.com/anuma-ai/sdk/blob/main/src/lib/db/entities/models.ts#20)
...
Defined in: [src/lib/db/entities/models.ts:22](https://github.com/anuma-ai/sdk/blob/main/src/lib/db/entities/models.ts#22)
...
> `static` **table**: `string` = `"entity"`

Defined in: [src/lib/db/entities/models.ts:15](https://github.com/anuma-ai/sdk/blob/main/src/lib/db/entities/models.ts#15)
...
> **update**(`recordUpdater?`: (`_`: `this`) => `void`): `Promise`<`Entity`>
