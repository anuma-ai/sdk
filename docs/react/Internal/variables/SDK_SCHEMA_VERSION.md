...
> `const` **SDK\_SCHEMA\_VERSION**: `20` = `20`

Defined in: [src/lib/db/schema.ts:43](https://github.com/anuma-ai/sdk/blob/main/src/lib/db/schema.ts#43)
...
* v20: Added embedding column to memory\_vault for persisted embedding vectors
