# DEFAULT\_SERVER\_TOOLS\_MATCH\_OPTIONS

> `const` **DEFAULT\_SERVER\_TOOLS\_MATCH\_OPTIONS**: [`ToolMatchOptions`](../interfaces/ToolMatchOptions.md)

Defined in: [src/lib/tools/serverTools.ts:1235](https://github.com/anuma-ai/sdk/blob/main/src/lib/tools/serverTools.ts#1235)
