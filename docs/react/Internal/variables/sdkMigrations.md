...
Defined in: [src/lib/db/schema.ts:243](https://github.com/anuma-ai/sdk/blob/main/src/lib/db/schema.ts#243)
...
* v19 → v20: Added `embedding` column to memory\_vault for persisted embedding vectors
