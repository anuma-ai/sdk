...
Defined in: [src/lib/db/schema.ts:168](https://github.com/zeta-chain/ai-sdk/blob/main/src/lib/db/schema.ts#L168)
...
* v8 → v9: Added memory conflict resolution (accessed\_at, supersedes, previous\_value) and thinking column
