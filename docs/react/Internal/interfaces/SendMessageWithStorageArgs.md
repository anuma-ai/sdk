...
Defined in: [src/lib/db/chat/types.ts:308](https://github.com/zeta-chain/ai-sdk/blob/main/src/lib/db/chat/types.ts#L308)
...
Defined in: [src/lib/db/chat/types.ts:334](https://github.com/zeta-chain/ai-sdk/blob/main/src/lib/db/chat/types.ts#L334)
