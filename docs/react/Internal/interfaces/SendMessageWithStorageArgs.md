...
Defined in: [src/lib/db/chat/types.ts:504](https://github.com/zeta-chain/ai-sdk/blob/main/src/lib/db/chat/types.ts#L504)
...
Defined in: [src/lib/db/chat/types.ts:533](https://github.com/zeta-chain/ai-sdk/blob/main/src/lib/db/chat/types.ts#L533)
