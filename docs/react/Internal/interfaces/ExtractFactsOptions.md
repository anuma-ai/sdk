...
Defined in: [src/lib/memory/autoExtract.ts:236](https://github.com/anuma-ai/sdk/blob/main/src/lib/memory/autoExtract.ts#236)

Optional per-call request path override, forwarded to
callPortalJsonCompletion. When set, extraction POSTs to
...
Invalid values throw at call time (see validateEndpointOverride).
...
Defined in: [src/lib/memory/autoExtract.ts:262](https://github.com/anuma-ai/sdk/blob/main/src/lib/memory/autoExtract.ts#262)
...
Defined in: [src/lib/memory/autoExtract.ts:246](https://github.com/anuma-ai/sdk/blob/main/src/lib/memory/autoExtract.ts#246)
