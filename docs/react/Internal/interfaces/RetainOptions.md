...
Defined in: [src/lib/memory/types.ts:432](https://github.com/anuma-ai/sdk/blob/main/src/lib/memory/types.ts#432)
...
Defined in: [src/lib/memory/types.ts:457](https://github.com/anuma-ai/sdk/blob/main/src/lib/memory/types.ts#457)
...
Facet value (v43) — the normalized current value token for [facetKey](#facetkey)
(e.g. "dark"/"light"). Only persisted alongside a valid [facetKey](#facetkey).
