...
Defined in: [src/lib/db/entities/operations.ts:474](https://github.com/anuma-ai/sdk/blob/main/src/lib/db/entities/operations.ts#474)
...
findOrphanedEntities) — otherwise a topic the extractor has disowned
