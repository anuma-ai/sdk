...
Defined in: [src/lib/db/media/operations.ts:344](https://github.com/zeta-chain/ai-sdk/blob/main/src/lib/db/media/operations.ts#L344)
...
[`MediaFilterOptions`](../interfaces/MediaFilterOptions.md)
