...
Defined in: [src/lib/db/media/operations.ts:246](https://github.com/zeta-chain/ai-sdk/blob/main/src/lib/db/media/operations.ts#L246)
...
[`UpdateMediaOptions`](../interfaces/UpdateMediaOptions.md)
