...
Defined in: [src/lib/db/entities/operations.ts:360](https://github.com/anuma-ai/sdk/blob/main/src/lib/db/entities/operations.ts#360)
...
memory\_entity rows whose `user_id` matches. Without this filter the
