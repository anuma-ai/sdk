...
> **EmbeddedWalletSignerFn** = (`message`) => `Promise`\<`string`\>

Defined in: [src/react/useEncryption.ts:527](https://github.com/zeta-chain/ai-sdk/blob/main/src/react/useEncryption.ts#L527)
