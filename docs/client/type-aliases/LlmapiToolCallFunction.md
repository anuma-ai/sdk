...
> **LlmapiToolCallFunction** = { `arguments?`: `string`; `name?`: `string`; }
...
Defined in: [src/client/types.gen.ts:945](https://github.com/zeta-chain/ai-sdk/blob/main/src/client/types.gen.ts#L945)
