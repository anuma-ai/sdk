# HandlersConnectorListItem

> **HandlersConnectorListItem** = `object`
...
> `optional` **external\_account**: `string`
...
> `optional` **granted\_scopes**: `string`\[]
