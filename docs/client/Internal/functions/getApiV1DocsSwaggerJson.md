...
Defined in: [src/client/sdk.gen.ts:238](https://github.com/zeta-chain/ai-sdk/blob/main/src/client/sdk.gen.ts#L238)
...
`RequestResult`<[`GetApiV1DocsSwaggerJsonResponses`](../type-aliases/GetApiV1DocsSwaggerJsonResponses.md), `unknown`, `ThrowOnError`>
