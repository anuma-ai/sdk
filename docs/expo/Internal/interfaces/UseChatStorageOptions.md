...
> `optional` **onPreProcessorArtifact**: (`artifact`: [`PreProcessorArtifact`](../../../react/Internal/type-aliases/PreProcessorArtifact.md)) => `void`
...
[`PreProcessorArtifact`](../../../react/Internal/type-aliases/PreProcessorArtifact.md)
