...
describe("FONT_LIBRARY", () => {
  ...
  it("includes the user's 40 named Google Fonts", () => {
    const required = [
      ...
      "Merriweather", "Oswald", "Ubuntu", "PT Sans", "Noto Sans",
      "Work Sans", "Rubik", "Fira Sans", "Quicksand", "Karla", "DM Sans",
      "Manrope", "Space Grotesk", "Libre Baskerville", "Crimson Text",
      "Lora", "Bitter", "Arvo", "Josefin Sans", "Cabin", "Dosis",
      "Comfortaa", "Abril Fatface", "Bebas Neue", "Righteous", "Pacifico",
      "Dancing Script", "Caveat", "Architects Daughter", "Permanent Marker",
    ];
