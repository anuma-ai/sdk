...
import { PERSONA_PRESETS } from "../lib/persona/presets.js";
 ...
 *
 * @deprecated Use `buildSystemPrompt` with the "app-builder" preset instead:
 * ```
 * import { buildSystemPrompt, PERSONA_PRESETS } from "@anuma/sdk";
 * const { prompt } = buildSystemPrompt({
 *   basePrompt: PERSONA_PRESETS["app-builder"].basePrompt,
 * });
 * ```
 */
export function buildAppSystemPrompt(): string {
  return PERSONA_PRESETS["app-builder"].basePrompt;
}
