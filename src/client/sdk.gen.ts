 ...
 */
export const postInternalModerate = <ThrowOnError extends boolean = false>(options: Options<PostInternalModerateData, ThrowOnError>) => (options.client ?? client).post<PostInternalModerateResponses, PostInternalModerateErrors, ThrowOnError>({
