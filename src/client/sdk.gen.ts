 ...
 */
export const getAdminReferralGrantsStats = <ThrowOnError extends boolean = false>(options?: Options<GetAdminReferralGrantsStatsData, ThrowOnError>) => (options?.client ?? client).get<GetAdminReferralGrantsStatsResponses, GetAdminReferralGrantsStatsErrors, ThrowOnError>({ url: '/admin/referral-grants/stats', ...options });
 ...
 */
export const postApiV1AccountVerifyChallenge = <ThrowOnError extends boolean = false>(options?: Options<PostApiV1AccountVerifyChallengeData, ThrowOnError>) => (options?.client ?? client).post<PostApiV1AccountVerifyChallengeResponses, PostApiV1AccountVerifyChallengeErrors, ThrowOnError>({ url: '/api/v1/account/verify-challenge', ...options });
 ...
 */
export const getApiV1AdminModerationCsam = <ThrowOnError extends boolean = false>(options: Options<GetApiV1AdminModerationCsamData, ThrowOnError>) => (options.client ?? client).get<GetApiV1AdminModerationCsamResponses, GetApiV1AdminModerationCsamErrors, ThrowOnError>({ url: '/api/v1/admin/moderation/csam', ...options });
 ...
 */
export const getApiV1AdminModerationCsamByIdHistory = <ThrowOnError extends boolean = false>(options: Options<GetApiV1AdminModerationCsamByIdHistoryData, ThrowOnError>) => (options.client ?? client).get<GetApiV1AdminModerationCsamByIdHistoryResponses, GetApiV1AdminModerationCsamByIdHistoryErrors, ThrowOnError>({ url: '/api/v1/admin/moderation/csam/{id}/history', ...options });

/**
 * Record a CSAM event disposition (admin)
 *
 * Proxies an operator's review to nearby (disposition ∈ reported_to_ncmec, account_actioned, dismissed) and returns the updated event. Requires admin API key.
 */
export const putApiV1AdminModerationCsamByIdReview = <ThrowOnError extends boolean = false>(options: Options<PutApiV1AdminModerationCsamByIdReviewData, ThrowOnError>) => (options.client ?? client).put<PutApiV1AdminModerationCsamByIdReviewResponses, PutApiV1AdminModerationCsamByIdReviewErrors, ThrowOnError>({
 ...
 */
export const getApiV1AdminNearbyAccessCodes = <ThrowOnError extends boolean = false>(options: Options<GetApiV1AdminNearbyAccessCodesData, ThrowOnError>) => (options.client ?? client).get<GetApiV1AdminNearbyAccessCodesResponses, GetApiV1AdminNearbyAccessCodesErrors, ThrowOnError>({ url: '/api/v1/admin/nearby/access-codes', ...options });
 ...
 */
export const postApiV1AdminNearbyAccessCodes = <ThrowOnError extends boolean = false>(options: Options<PostApiV1AdminNearbyAccessCodesData, ThrowOnError>) => (options.client ?? client).post<PostApiV1AdminNearbyAccessCodesResponses, PostApiV1AdminNearbyAccessCodesErrors, ThrowOnError>({
 ...
 */
export const postApiV1AdminNearbyAccessCodesRevoke = <ThrowOnError extends boolean = false>(options: Options<PostApiV1AdminNearbyAccessCodesRevokeData, ThrowOnError>) => (options.client ?? client).post<PostApiV1AdminNearbyAccessCodesRevokeResponses, PostApiV1AdminNearbyAccessCodesRevokeErrors, ThrowOnError>({
 ...
 */
export const getApiV1AdminNearbyMeetupsById = <ThrowOnError extends boolean = false>(options: Options<GetApiV1AdminNearbyMeetupsByIdData, ThrowOnError>) => (options.client ?? client).get<GetApiV1AdminNearbyMeetupsByIdResponses, GetApiV1AdminNearbyMeetupsByIdErrors, ThrowOnError>({ url: '/api/v1/admin/nearby/meetups/{id}', ...options });

/**
 * Announce a new model via push notification (admin)
 *
 * Creates an immediately-scheduled announcement campaign for a curated model (delivery is asynchronous and preference-gated; only announcements opt-ins receive it). Title and body default from the catalog entry; the tap deep-links to the in-app models screen. Idempotent per model_id — repeat calls return 409 unless force=true. Track delivery via GET /api/v1/admin/notifications/campaigns/{campaign_id}.
 */
 ...
 */
export const getApiV1AdminNotificationsCampaigns = <ThrowOnError extends boolean = false>(options: Options<GetApiV1AdminNotificationsCampaignsData, ThrowOnError>) => (options.client ?? client).get<GetApiV1AdminNotificationsCampaignsResponses, GetApiV1AdminNotificationsCampaignsErrors, ThrowOnError>({ url: '/api/v1/admin/notifications/campaigns', ...options });

/**
 * Create an announcement campaign (admin)
 *
 * Creates a push announcement campaign. Status "draft" (default) is inert; "scheduled" requires scheduled_at and is drained by the campaign worker once due. Delivery enforces the per-recipient announcements opt-in regardless of segment.
 */
export const postApiV1AdminNotificationsCampaigns = <ThrowOnError extends boolean = false>(options: Options<PostApiV1AdminNotificationsCampaignsData, ThrowOnError>) => (options.client ?? client).post<PostApiV1AdminNotificationsCampaignsResponses, PostApiV1AdminNotificationsCampaignsErrors, ThrowOnError>({
 ...
 */
export const getApiV1AdminNotificationsCampaignsByCampaignId = <ThrowOnError extends boolean = false>(options: Options<GetApiV1AdminNotificationsCampaignsByCampaignIdData, ThrowOnError>) => (options.client ?? client).get<GetApiV1AdminNotificationsCampaignsByCampaignIdResponses, GetApiV1AdminNotificationsCampaignsByCampaignIdErrors, ThrowOnError>({ url: '/api/v1/admin/notifications/campaigns/{campaign_id}', ...options });
 ...
 */
export const patchApiV1AdminNotificationsCampaignsByCampaignId = <ThrowOnError extends boolean = false>(options: Options<PatchApiV1AdminNotificationsCampaignsByCampaignIdData, ThrowOnError>) => (options.client ?? client).patch<PatchApiV1AdminNotificationsCampaignsByCampaignIdResponses, PatchApiV1AdminNotificationsCampaignsByCampaignIdErrors, ThrowOnError>({
 ...
 */
export const postApiV1AdminNotificationsCampaignsByCampaignIdCancel = <ThrowOnError extends boolean = false>(options: Options<PostApiV1AdminNotificationsCampaignsByCampaignIdCancelData, ThrowOnError>) => (options.client ?? client).post<PostApiV1AdminNotificationsCampaignsByCampaignIdCancelResponses, PostApiV1AdminNotificationsCampaignsByCampaignIdCancelErrors, ThrowOnError>({ url: '/api/v1/admin/notifications/campaigns/{campaign_id}/cancel', ...options });

/**
 * Send test push notification (admin)
 *
 * Sends an Expo push to every device registered under the resolved account. Exactly one of account_id or user_address must be provided. When event_type is set, the send routes through the full dispatch pipeline (kill-switch, category mapping, recipient preference, Android channelId) — 409 means the recipient's preference blocked it, 503 means the event type is kill-switched. Returns the per-device delivery breakdown including any rows pruned because Expo reported DeviceNotRegistered.
 */
 ...
 *
 * Reports how many wallet accounts with a Privy DID already have phone_hash set vs have a Privy-linked phone that still needs hashing. Read-only.
 */
export const getApiV1AdminPhoneHashesAudit = <ThrowOnError extends boolean = false>(options: Options<GetApiV1AdminPhoneHashesAuditData, ThrowOnError>) => (options.client ?? client).get<GetApiV1AdminPhoneHashesAuditResponses, GetApiV1AdminPhoneHashesAuditErrors, ThrowOnError>({ url: '/api/v1/admin/phone-hashes/audit', ...options });

/**
 * Backfill phone hashes from Privy
 *
 * For each wallet account with a Privy DID, fetches the linked phone from Privy and upserts accounts.phone_hash. Idempotent; unique collisions are counted, not fatal.
 */
export const postApiV1AdminPhoneHashesBackfill = <ThrowOnError extends boolean = false>(options: Options<PostApiV1AdminPhoneHashesBackfillData, ThrowOnError>) => (options.client ?? client).post<PostApiV1AdminPhoneHashesBackfillResponses, PostApiV1AdminPhoneHashesBackfillErrors, ThrowOnError>({ url: '/api/v1/admin/phone-hashes/backfill', ...options });
 ...
 */
export const postApiV1AdminUsersInternalTester = <ThrowOnError extends boolean = false>(options: Options<PostApiV1AdminUsersInternalTesterData, ThrowOnError>) => (options.client ?? client).post<PostApiV1AdminUsersInternalTesterResponses, PostApiV1AdminUsersInternalTesterErrors, ThrowOnError>({
 ...
 *
 * Retrieves account details, all app enrollments with balances, and text registrations. Accepts wallet_address, phone, telegram, email or account_id (exactly one required). The response's privy block carries the email, resolved from the account's Privy DID when the query itself did not go through Privy. When the identifier resolves to a Privy user that has no portal account (e.g. a Privy signup that never onboarded), returns 200 with account=null, portal_account_exists=false, and a privy block describing the Privy identity, instead of 404 — so an operator can still see (and delete) the Privy user.
 */
 ...
 */
export const postApiV1AdminUsersNearbyBeta = <ThrowOnError extends boolean = false>(options: Options<PostApiV1AdminUsersNearbyBetaData, ThrowOnError>) => (options.client ?? client).post<PostApiV1AdminUsersNearbyBetaResponses, PostApiV1AdminUsersNearbyBetaErrors, ThrowOnError>({
 ...
 */
export const getApiV1NotificationsPreferences = <ThrowOnError extends boolean = false>(options?: Options<GetApiV1NotificationsPreferencesData, ThrowOnError>) => (options?.client ?? client).get<GetApiV1NotificationsPreferencesResponses, GetApiV1NotificationsPreferencesErrors, ThrowOnError>({ url: '/api/v1/notifications/preferences', ...options });
 ...
 */
export const putApiV1NotificationsPreferences = <ThrowOnError extends boolean = false>(options: Options<PutApiV1NotificationsPreferencesData, ThrowOnError>) => (options.client ?? client).put<PutApiV1NotificationsPreferencesResponses, PutApiV1NotificationsPreferencesErrors, ThrowOnError>({
 ...
 */
export const postApiV1UtilityChatCompletions = <ThrowOnError extends boolean = false>(options: Options<PostApiV1UtilityChatCompletionsData, ThrowOnError>) => (options.client ?? client).post<PostApiV1UtilityChatCompletionsResponses, PostApiV1UtilityChatCompletionsErrors, ThrowOnError>({
 ...
 */
export const postApiV1UtilityResponses = <ThrowOnError extends boolean = false>(options: Options<PostApiV1UtilityResponsesData, ThrowOnError>) => (options.client ?? client).post<PostApiV1UtilityResponsesResponses, PostApiV1UtilityResponsesErrors, ThrowOnError>({
 ...
 */
export const postInternalAccountsByPhoneHashes = <ThrowOnError extends boolean = false>(options: Options<PostInternalAccountsByPhoneHashesData, ThrowOnError>) => (options.client ?? client).post<PostInternalAccountsByPhoneHashesResponses, PostInternalAccountsByPhoneHashesErrors, ThrowOnError>({
 ...
 *
 * Internal service-to-service endpoint used by the nearby service to generate short completions without the user credit gate. Model is pinned server-side to an open-weights model and max_completion_tokens is clamped. Forwards raw to the gateway; no balance hold, settlement, or moderation — the caller must moderate output it displays. Non-streaming. Gated behind the shared X-Service-Key.
 */
export const postInternalComplete = <ThrowOnError extends boolean = false>(options: Options<PostInternalCompleteData, ThrowOnError>) => (options.client ?? client).post<PostInternalCompleteResponses, PostInternalCompleteErrors, ThrowOnError>({
 ...
 *
 * Internal service-to-service endpoint used by the nearby service to push a recipient when a new DM request lands. Fires once per request, carrying the sender's display name only, never message content. A recipient who opted out of the messages category, has no registered devices, or triggers an event type silenced by the kill-switch, is reported as 200 with zero counts, not an error. sender_display_name must already be moderated by the caller. Gated behind the shared X-Service-Key.
 */
export const postInternalDmRequests = <ThrowOnError extends boolean = false>(options: Options<PostInternalDmRequestsData, ThrowOnError>) => (options.client ?? client).post<PostInternalDmRequestsResponses, PostInternalDmRequestsErrors, ThrowOnError>({
 ...
 */
export const postInternalEmbeddings = <ThrowOnError extends boolean = false>(options: Options<PostInternalEmbeddingsData, ThrowOnError>) => (options.client ?? client).post<PostInternalEmbeddingsResponses, PostInternalEmbeddingsErrors, ThrowOnError>({
 ...
 */
export const postInternalExtractPhotoFacts = <ThrowOnError extends boolean = false>(options: Options<PostInternalExtractPhotoFactsData, ThrowOnError>) => (options.client ?? client).post<PostInternalExtractPhotoFactsResponses, PostInternalExtractPhotoFactsErrors, ThrowOnError>({
 ...
 *
 * Internal service-to-service endpoint used by the nearby service to push a meetup host when a guest's join is accepted. Fires one push per join (no digesting yet — see the handler doc). A host who opted out of the social category, has no registered devices, or triggers an event type silenced by the kill-switch, is reported as 200 with zero counts, not an error. guest_display_name must already be moderated by the caller. Gated behind the shared X-Service-Key.
 */
export const postInternalMeetupsJoins = <ThrowOnError extends boolean = false>(options: Options<PostInternalMeetupsJoinsData, ThrowOnError>) => (options.client ?? client).post<PostInternalMeetupsJoinsResponses, PostInternalMeetupsJoinsErrors, ThrowOnError>({
 ...
 */
export const postInternalNearbyActivations = <ThrowOnError extends boolean = false>(options: Options<PostInternalNearbyActivationsData, ThrowOnError>) => (options.client ?? client).post<PostInternalNearbyActivationsResponses, PostInternalNearbyActivationsErrors, ThrowOnError>({
 ...
 */
export const postInternalPrefineryClaimTokens = <ThrowOnError extends boolean = false>(options: Options<PostInternalPrefineryClaimTokensData, ThrowOnError>) => (options.client ?? client).post<PostInternalPrefineryClaimTokensResponses, PostInternalPrefineryClaimTokensErrors, ThrowOnError>({
 ...
 */
export const getNearbyAccess = <ThrowOnError extends boolean = false>(options?: Options<GetNearbyAccessData, ThrowOnError>) => (options?.client ?? client).get<GetNearbyAccessResponses, GetNearbyAccessErrors, ThrowOnError>({ url: '/nearby/access', ...options });
 ...
 */
export const postNearbyAccessCode = <ThrowOnError extends boolean = false>(options: Options<PostNearbyAccessCodeData, ThrowOnError>) => (options.client ?? client).post<PostNearbyAccessCodeResponses, PostNearbyAccessCodeErrors, ThrowOnError>({
 ...
 */
export const postNearbyWaitlist = <ThrowOnError extends boolean = false>(options: Options<PostNearbyWaitlistData, ThrowOnError>) => (options.client ?? client).post<PostNearbyWaitlistResponses, PostNearbyWaitlistErrors, ThrowOnError>({
    url: '/nearby/waitlist',
    ...options,
    headers: {
        'Content-Type': 'application/json',
 ...
 */
export const postReferralClaim = <ThrowOnError extends boolean = false>(options: Options<PostReferralClaimData, ThrowOnError>) => (options.client ?? client).post<PostReferralClaimResponses, PostReferralClaimErrors, ThrowOnError>({
    url: '/referral/claim',
    ...options,
    headers: {
        'Content-Type': 'application/json',
 ...
 */
export const postReferralIdentity = <ThrowOnError extends boolean = false>(options?: Options<PostReferralIdentityData, ThrowOnError>) => (options?.client ?? client).post<PostReferralIdentityResponses, PostReferralIdentityErrors, ThrowOnError>({ url: '/referral/identity', ...options });
 ...
 */
export const postReferralInvite = <ThrowOnError extends boolean = false>(options: Options<PostReferralInviteData, ThrowOnError>) => (options.client ?? client).post<PostReferralInviteResponses, PostReferralInviteErrors, ThrowOnError>({
    url: '/referral/invite',
    ...options,
    headers: {
        'Content-Type': 'application/json',
 ...
 *
 * Served entirely from the portal's mirror; never calls Prefinery. Safe to poll — tester.updated_at is the freshness signal.
 */
export const getReferralMe = <ThrowOnError extends boolean = false>(options?: Options<GetReferralMeData, ThrowOnError>) => (options?.client ?? client).get<GetReferralMeResponses, GetReferralMeErrors, ThrowOnError>({ url: '/referral/me', ...options });
 ...
 */
export const getReferralRewards = <ThrowOnError extends boolean = false>(options?: Options<GetReferralRewardsData, ThrowOnError>) => (options?.client ?? client).get<GetReferralRewardsResponses, GetReferralRewardsErrors, ThrowOnError>({ url: '/referral/rewards', ...options });

/**
 * Prefinery webhook receiver
 *
 * Public route authenticated by X-Prefinery-Signature (HMAC-SHA256 over "{t}.{raw_body}"). Persists the raw event and acks inside Prefinery's 15s budget; processing is asynchronous and order-independent.
 */
export const postWebhooksPrefinery = <ThrowOnError extends boolean = false>(options?: Options<PostWebhooksPrefineryData, ThrowOnError>) => (options?.client ?? client).post<PostWebhooksPrefineryResponses, PostWebhooksPrefineryErrors, ThrowOnError>({
