 ...
 */
export const postApiV1UtilityResponses = <ThrowOnError extends boolean = false>(options: Options<PostApiV1UtilityResponsesData, ThrowOnError>) => {
    return (options.client ?? client).post<PostApiV1UtilityResponsesResponses, PostApiV1UtilityResponsesErrors, ThrowOnError>({
 ...
 */
export const postInternalEmbeddings = <ThrowOnError extends boolean = false>(options: Options<PostInternalEmbeddingsData, ThrowOnError>) => {
    return (options.client ?? client).post<PostInternalEmbeddingsResponses, PostInternalEmbeddingsErrors, ThrowOnError>({
 ...
 */
export const postInternalModerate = <ThrowOnError extends boolean = false>(options: Options<PostInternalModerateData, ThrowOnError>) => {
    return (options.client ?? client).post<PostInternalModerateResponses, PostInternalModerateErrors, ThrowOnError>({
