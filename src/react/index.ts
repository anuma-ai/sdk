...
// Off-chain primitives ship in this module. Chain integration plugs in via the
// BlockchainAdapter interface (real ZetaChain adapter is implemented separately).
export {
  type AnchorResult,
