 ...
 * - v20: Added embedding column to memory_vault for persisted embedding vectors
 */
 ...
 * - v19 → v20: Added `embedding` column to memory_vault for persisted embedding vectors
 */
