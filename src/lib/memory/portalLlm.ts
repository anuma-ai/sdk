 ...
 * the portal would have forced, and a caller cannot dial these calls' reasoning
 * back UP through the portal today — verified 2026-08-14, `low` and `none`
 * returned byte-identical token counts.
 */
