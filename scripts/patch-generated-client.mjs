...
const patches = [
  {
    // openapi-ts wipes src/client/ on every `pnpm spec` run, so any
    // hand-written file inside that directory would be lost. We keep the
    // compat shims at `src/clientCompat.ts` (outside the output dir) and
    // append a re-export here. Named re-exports below shadow the wildcard
    // `export type *` above for the listed identifiers.
    file: "src/client/index.ts",
    find: `// This file is auto-generated by @hey-api/openapi-ts

export type * from './types.gen';
export * from './sdk.gen';`,
    replace: `// This file is auto-generated by @hey-api/openapi-ts
