...
async function main() {
  ...
  const tsLines = [
    ...
    "//",
    "// Coverage caveat: /api/v1/models does NOT list the alias ids consumer",
    "// apps actually send (e.g. `kimi/kimi-k2.6`). Aliases are probed only if",
    "// added to EXTRA_MODELS in scripts/update-model-apis.ts; anything absent",
    '// from this map falls back to "responses" in getApiTypeForModel.',
    "",
